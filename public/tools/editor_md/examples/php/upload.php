<?php
	...
	//保存到/templates/uploads中
	$savePath = realpath(dirname(dirname(dirname($path))) . '/uploads/') . DIRECTORY_SEPARATOR;
	$saveURL  = dirname(dirname(dirname($url))) . '/uploads/';

	//$arr = ['success'=>0, 'message'=>$saveURL, 'url'=>'www.fire.com'];
    ...
    {        
        $imageUploader = new EditorMdUploader($savePath, $saveURL, $formats['image'], 2, 15);  // Ymdhis表示按日期生成文件名，利用date()函数
