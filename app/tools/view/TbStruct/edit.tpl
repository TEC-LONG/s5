...
<div class="pageContent">
	...
	<form enctype="multipart/form-data" method="post" action="{$editUrl}/id/{$thisRow['id']}" class="pageForm required-validate" onsubmit="return iframeCallback(this, navTabAjaxDone)">
