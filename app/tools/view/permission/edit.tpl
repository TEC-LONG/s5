<div class="pageContent">
	<form method="post" action="{$url.pPost.url}" class="pageForm required-validate" onsubmit="return validateCallback(this, permissionAjaxDone);">
		{if isset($row.id)}
