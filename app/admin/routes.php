...
///  admin/
    ...
    Route::post('article/cate/post', 'ArticleCategory@post')->navtab('admin_article_category_index')->name();
    Route::post('article/cate/child', 'ArticleCategory@getChild')->navtab('admin_article_category_index')->name();
    ...
    Route::get('article/delete', 'Article@del')->navtab('admin_article_index')->name();
