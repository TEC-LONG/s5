...
class MenuPermissionModel extends Model{
    ...
    public function getAllLevelMenu(){
        ...
        $lv1 = $this->table('menu_permission')->select('*')->where(['level', 1])->get();

        $lv2 = $this->table('menu_permission')->select('*')->where(['level', 2])->get();

        $lv3 = $this->table('menu_permission')->select('*')->where(['level', 3])->get();

        $lv4 = $this->table('menu_permission')->select('*')->where(['level', 'in', '(3, 4)'])->get();
